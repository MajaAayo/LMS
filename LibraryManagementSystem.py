...
def searchBook(library):  
   clearScreen()  
   search_title = input("Enter the title of the book to search: ").strip()  
   found = False  
   for book in library:  
      if 'title' in book and 'author' in book and 'price' in book:  
        if book['title'].lower() == search_title.lower():  
           print(f"Book found: {book['title']} by {book['author']} cost Rs. {book['price']}")  
           found = True  
           break  
   if not found:  
